...
/**
 * ★ تبديلُ الهويّة داخل التبويب (بدءُ الانتحال) يُسقط الوصلةَ لتُبنى بالتوكن
 *   الجديد: الغرفُ تُشتقّ من التوكن عند المصافحة، فوصلةٌ قائمةٌ تبقى في غرفة
 *   الحساب القديم — وتُسمع شاشةَ العميل المنتحَل أحداثَ غيره.
 */
