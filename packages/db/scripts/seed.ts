...
async function main() {
  ...
  if (!password) {
    ...
    /* ★ ولا يُولَّد سرُّ عاملٍ ثانٍ هنا: سرٌّ تطبعه بذرةٌ يراه المشغّل سرٌّ
       مشترك، فيصير العاملُ الثاني زينةً. والتسجيلُ من المتصفّح عند أوّل دخول. */
    console.log('  ولا عاملَ ثانٍ بعد — اللوحة مغلقةٌ حتّى يُفعّله من شاشة أوّل دخول.');
  }
