...
export const conversations = pgTable('conversations', {
   ...
   */
  /**
   * ★★ **إلى أيّ رسالةٍ واردةٍ وصل ردُّ البوت** — بوّابةُ «لا ردَّ بلا جديد».
   *
   * رسائلُ الزبون التي تصل أثناء التوليد كانت تُنتج مهمّةً جانبيّةً لكلّ
   * واحدة تعمل **بالتوازي** مع الردّ الجاري، فكلٌّ يقرأ تاريخاً لا يحوي ردَّ
   * الآخر — فيصل الزبونَ ترحيبان. وقِيس التوازي فعلاً: مهمّتان بمعرّفَين
   * مختلفَين على المحادثة نفسها عملتا معاً.
   *
   * ⚠️ ولا يُقارَن بآخرِ **صادر**: صفُّ الردّ يُحجَز بعد التوليد فتاريخُه
   *    أحدثُ من رسالةٍ وصلت في أثنائه — فبوّابةٌ تقارن بالصادر تُسقط تلك
   *    الرسالة صامتةً إلى الأبد. وهذا العمودُ زمنُ أحدثِ واردٍ **رآه
   *    المخطِّط**، فرسالةٌ وصلت بعده تُجاب حتماً في الدورة التالية.
   */
  botAnsweredAt: timestamp('bot_answered_at', { withTimezone: true }),
