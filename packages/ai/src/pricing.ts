...
/**
 * ★ التسعير **لحظة النداء** لا لحظة العرض: `reply.ts` يحسب الكلفةَ من صفّ
 *   `prices` الساري ويجمّدها في `ai_runs.cost_usd` و`conversation_windows.ai_cost_usd`
 *   — كفاتورة. فتصحيحُ سعرٍ يسري على ما بعده **ولا يصحّح التاريخ من تلقاء نفسه**.
 *   (كان مكتوباً هنا وفي `0005` أنّ التصحيح رجعيٌّ — ولم يكن شيءٌ يفعله.)
 *   ومن أراد إعادةَ تسعير ما مضى فالأداةُ صريحةٌ ومسجَّلة: `ops/reprice.ts`.
